var PMShape = function (options) {
    ...
    this.businessObject = {};
    /**
     * output elements connected to this element
     * @type {Array}
     */
    this.outgoingElements = null;
    /**
     * input elements connected to this element
     * @type {Array}
     */
    this.incomingElements = null;
...
PMShape.prototype.init = function (options) {
    ...
    this.outgoingElements = new PMUI.util.ArrayList();
    this.incomingElements = new PMUI.util.ArrayList();

    this.setExtended(defaults.extended)
        .setExtendedType(defaults.extendedType)
        .setRelationship(defaults.relationship)
        .setIncomingElements(defaults.incomingElements)
        .setOutgoingElements(defaults.outgoingElements);
    if (defaults.markers) {
...
/**
 * fixed the connected inputs
 * @param elements{Array}
 * @returns {PMShape}
 */
PMShape.prototype.setIncomingElements = function(elements){
    var i;
    if (jQuery.isArray(elements)) {
        this.incomingElements.clear();
        for (i = 0; i < elements.length; i += 1) {
            this.addIncomingElement(elements[i]);
        }
    }
    return this;
};
/**
 * add an item to the list of items connected input
 * @param element{PMShape}
 * @returns {PMShape}
 */
PMShape.prototype.addIncomingElement = function(element){
    this.incomingElements.insert(element);
    return this;
};
/**
 * remove an item to the list of items connected input
 * @param element{PMShape}
 * @returns {PMShape}
 */
PMShape.prototype.removeIncomingElement = function(element){
    this.incomingElements.remove(element);
    return this;
};
/**
 * return the list of elements connected input
 * @param element{PMShape}
 * @returns {PMShape}
 */
PMShape.prototype.getIncomingElements = function(){
    return this.incomingElements.asArray();
};
/**
 * fixed the connected outputs
 * @param elements{Array}
 * @returns {PMShape}
 */
PMShape.prototype.setOutgoingElements = function(elements){
    var i;
    if (jQuery.isArray(elements)) {
        this.outgoingElements.clear();
        for (i = 0; i < elements.length; i += 1) {
            this.addOutgoingElement(elements[i]);
        }
    }
    return this;
};
/**
 * add an item to the list of items connected output
 * @param element{PMShape}
 * @returns {PMShape}
 */
PMShape.prototype.addOutgoingElement = function(element){
    this.outgoingElements.insert(element);
    return this;
};
/**
 * remove an item to the list of items connected output
 * @param element{PMShape}
 * @returns {PMShape}
 */
PMShape.prototype.removeOutgoingElement = function(element){
    this.outgoingElements.remove(element);
    return this;
};
/**
 * return the list of elements connected output
 * @param element{PMShape}
 * @returns {PMShape}
 */
PMShape.prototype.getOutgoingElements = function(){
    return this.outgoingElements.asArray();
};